...
public class Testcase3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("order_ship_address_attributes_firstname")).sendKeys("shubham",Keys.TAB);
		driver.findElement(By.id("order_ship_address_attributes_lastname")).sendKeys(Keys.CLEAR,"nimbalkar",Keys.TAB);
